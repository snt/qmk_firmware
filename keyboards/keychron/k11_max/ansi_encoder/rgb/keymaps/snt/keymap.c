...
#define KS_MAC_BASE_5   KC_ESC, KC_LOPTN, MT(MOD_LGUI,KC_LANGUAGE_2), MT(MOD_LGUI,KC_SPC), KC_SPC,  MO(FN2), KC_LANGUAGE_1, MO(MAC_FN1), KC_LEFT, KC_DOWN, KC_RGHT
#define CS_MAC_BASE_5   C_CTCHL, C_MODIF, C_LANGE,                    C_MODIF,             C_SPCHL, C_LAYER, C_LANGE,       C_LAYER,     C_CURSR, C_CURSR, C_CURSR
...
#define KS_WIN_BASE_5   KC_ESC , KC_LALT, MT(MOD_LGUI,KC_LANGUAGE_2), MT(MOD_LCTL,KC_SPC),KC_SPC,  MO(FN2), KC_LANGUAGE_1, MO(WIN_FN1), KC_LEFT, KC_DOWN, KC_RGHT
#define CS_WIN_BASE_5   C_CTCHL, C_MODIF, C_LANGE,                    C_MODIF,            C_SPCHL, C_LAYER, C_LANGE,       C_LAYER,     C_CURSR, C_CURSR, C_CURSR
...
#define KS_MAC_FN1_4    _______, _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_PGUP
#define CS_MAC_FN1_4    C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_LETTR, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_CTCHL
...
#define KS_WIN_FN1_4    _______, _______, _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_PGUP
#define CS_WIN_FN1_4    C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_LETTR, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_NONEX, C_CTCHL
...
#define CS_FN2_3        C_LAYER, C_SPCHL, C_BRAKT, C_BRAKT, C_SPCHL, C_SPCHL, C_SPCHL,  C_OPERA, C_TENKY, C_TENKY, C_TENKY, C_NONEX, C_NONEX, C_NONEX
