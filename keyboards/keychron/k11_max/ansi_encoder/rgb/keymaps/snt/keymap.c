...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_ESC, KC_LOPTN,/**/ MT(MOD_LGUI,KC_LANGUAGE_2),KC_SPC,MT(MOD_LGUI,KC_SPC),/**/ MO(FN2), KC_LANGUAGE_1, MO(MAC_FN1), /**/ KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_69_ansi(
        ...
        MO(COMPAT),KC_A,   KC_S,	 KC_D,	  KC_F,    KC_G,    /******/  KC_H,    KC_J,	KC_K,	 KC_L,	 LT(WIN_VIM,KC_SCLN),
                                                                                                                         KC_QUOT,           KC_ENT,  /******/ KC_HOME,
        KC_LSFT, /******/  KC_Z,	 KC_X,	  KC_C,    KC_V,	KC_B,	  KC_B,    KC_N,	KC_M,	 KC_COMM,  KC_DOT,	 KC_SLSH,  KC_RSFT, KC_UP,   /******/
        KC_ESC , KC_LALT,/**/ MT(MOD_LGUI,KC_LANGUAGE_2),KC_SPC, MT(MOD_LCTL,KC_SPC),/**/ MO(FN2), KC_LANGUAGE_1,MO(WIN_FN1), /**/ KC_LEFT, KC_DOWN, KC_RGHT),
