...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_ESC, KC_LOPTN,/**/ MT(MOD_LGUI,KC_LANGUAGE_2),MT(MOD_LGUI,KC_SPC),KC_SPC,/**/ MO(FN2), KC_LANGUAGE_1, MO(MAC_FN1), /**/ KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_69_ansi(
        ...
        MO(COMPAT),KC_A,   KC_S,	 KC_D,	  KC_F,    KC_G,    /******/  KC_H,    KC_J,	KC_K,	 KC_L,	 LT(WIN_VIM,KC_SCLN),
                                                                                                                         KC_QUOT,           KC_ENT,  /******/ KC_HOME,
        KC_LSFT, /******/  KC_Z,	 KC_X,	  KC_C,    KC_V,	KC_B,	  KC_B,    KC_N,	KC_M,	 KC_COMM,  KC_DOT,	 KC_SLSH,  KC_RSFT, KC_UP,   /******/
        KC_ESC , KC_LALT,/**/ MT(MOD_LGUI,KC_LANGUAGE_2),MT(MOD_LCTL,KC_SPC),KC_SPC,/**/ MO(FN2), KC_LANGUAGE_1,MO(WIN_FN1), /**/ KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_FN1] = LAYOUT_69_ansi(
        ...
        RGB_TOG, RGB_MOD,  RGB_VAI,  RGB_HUI, RGB_SAI, RGB_SPI, /******/  _______, _______, _______, _______,  _______,  _______,  _______, /******/ KC_END,
        _______, /******/  RGB_RMOD, RGB_VAD, RGB_HUD, RGB_SAD, RGB_SPD,  _______, NK_TOGG, _______, _______,  _______,  _______,  _______, KC_PGUP, /******/
        _______, _______,  KC_LEFT_GUI,  /******/ _______, /******/ _______,  _______, /******/ _______, /******/  _______,  /******/  _______, KC_PGDN, _______),
    ...
    [WIN_VIM] = LAYOUT_69_ansi(
        ...
        _______, /******/KC_MS_WH_DOWN,
                                     _______, _______, _______, _______,  _______, _______, _______, _______,  _______,  _______,  _______, _______, /******/
        _______, _______,KC_MS_BTN2,/******/KC_MS_BTN1,/******/ _______,RALT(KC_LEFT), /******/
                                                                                      RALT(KC_RIGHT), /******/  _______,  /******/  _______, _______, KC_SYSTEM_SLEEP),
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [MAC_BASE] = {
        C_SPCHL, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_SPCHL, C_SPCHL, C_CTCHL,
        ...
        C_CTCHL, C_MODIF, C_LANGE, C_MODIF, C_SPCHL, C_LAYER, C_LANGE, C_LAYER, C_CURSR, C_CURSR, C_CURSR
    },
    ...
    [WIN_BASE] = {
        ...
        C_LAYER, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LAYER, C_SPCHL, C_ENTER, C_CTCHL,
        C_MODIF, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_LETTR, C_SPCHL, C_SPCHL, C_SPCHL, C_MODIF, C_CURSR,
        C_CTCHL, C_MODIF, C_LANGE,C_LANGE, C_SPCHL, C_LAYER, C_LANGE, C_LAYER, C_CURSR, C_CURSR, C_CURSR
    },
    ...
    [FN2] = {
        C_SPCHL, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_FNKEY, C_LETTR,
